...
gt_path     = "/home/group_work/arc_project/data/ARCdataset_png/test_known/segmentation/"
# gt_path     = "./label/"

# Result image's dir path
result_path = "/home/group_work/out_epoch130/segmentation_results_gray/"
# result_path = "./results/"
...
for file_path in FILE_pre:
    ...
    pre_img = cv2.resize(pre_img, (gt_img.shape[1],gt_img.shape[0]))
